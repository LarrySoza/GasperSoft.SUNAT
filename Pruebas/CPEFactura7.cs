...
namespace Pruebas
{
    internal class CPEFactura7
    {
        /// <summary>
        /// FACTURA CON ANTICIPOS - MONTO TOTAL EN CERO
        /// </summary>
        public static CPEType GetDocumento()
        {
            ...
            //En este ejemplo anteriormente al cliente le emití 2 facturas por 590 soles cada una a manera de anticipos
            ...
            var _cpe = new CPEType()
            {
                ...
                totalOperacionesGravadas = 0,//la suma del valor venta de todos los items grabados - la suma de totalOperacionesGravadas de todos los anticipos
                sumatoriaIGV = 0,//Cuando hay anticipos este valor se recalcula en base a las totalOperacionesGravadas * 0.18
                sumatoriaImpuestos = 0,//en este caso solo hay IGV pero si hubiera ICBPER tambien se suma aqui
                ...
                totalAnticipos = 1180,//sumatoria del importeTotal de cada anticipo
                importeTotal = 0,//precioVenta- total antipos
            };
